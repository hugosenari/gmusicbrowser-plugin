=gmbplugin COUCHDB
name	Couchdb
title	Couchdb import/export tool
desc	Allows user to import/export configs with couchdb
req	perl(CouchDB::Client::DB, Digest::MD5)
=cut

package GMB::Plugin::COUCHDB;
...
sub prefbox 
{
        ...
        $::Options{OPT.'PORT'}=5984 unless defined $::Options{OPT.'PORT'};
        #options fields
	...
	my $password=::NewPrefEntry(OPT.'PASS', "password:",hide => 1, tip => "can be empty");
        ...
        my $port=::NewPrefEntry(OPT.'PORT', "couchdb port:", tip => "ie: 5984");
        my $dbname=::NewPrefEntry(OPT.'DBNAME', "couchdb database:", tip => "ie: gmusicbrowser");
        my $rbox=::Vpack($dbhost,$port,$dbname);
